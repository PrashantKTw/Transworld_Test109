...
function validate(){
   ...
   if(reason1.checked==true){
   	...
   	// alert(reason2.value);
       	...
       	// alert(reason3.value);
      }else if(reason4.checked==true){
           }else{
					alert("Please select type of leave required");
					return false;
               }
               ...
               Calendar.setup(
               {
                    ...
                    button      : "trigger"       // ID of the button
									...
									<tr>
										...
										<td align="left"><input type="radio" name="reason"
											...
											value="sick leave" />Sick leave <input type="radio"
											name="reason" id="reason4" value="Office work" />Office work</td>
									</tr>
									<tr>
										<td></td>
									</tr>
