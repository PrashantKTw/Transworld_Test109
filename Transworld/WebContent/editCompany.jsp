...
while(rs.next())
{
  %>
	...
	<br>
	<form
		action="EditDeptData.jsp?action=Companyedit&cmpCode=<%=cmpCode %>"
					...
					<table border="0" align="center" height="280">
						<tr>
							...
							<td><input type="text" name="compName" id="compName"
								value="<%=rs.getString("OurCompanyName")%>"
						...
						<tr>
							...
							<td><textarea name="compAdd" id="compAdd"
									style="width: 200px; padding: 4px 5px 2px 5px; border-color: activeborder; font: normal 11px Arial, Helvetica, sans-serif; color: #000000;"><%=rs.getString("OurCompanyAddress") %></textarea>
							</td>
							...
							<td><textarea name="compGdAdd" id="compGdAdd"
									style="width: 200px; padding: 4px 5px 2px 5px; border-color: activeborder; font: normal 11px Arial, Helvetica, sans-serif; color: #000000;"><%=rs.getString("OurCompanyGodownAddress") %></textarea>
							</td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" name="compBstno" id="compBstno"
								value="<%=rs.getString("OurCompanyBSTNo") %>"
								style="width: 200px; padding: 4px 5px 2px 5px; border-color: activeborder; font: normal 11px Arial, Helvetica, sans-serif; color: #000000;" />
							</td>
							...
							<td><input type="text" name="compCstno" id="compCstno"
								value="<%=rs.getString("OurCompanyCSTNo") %>"
								style="width: 200px; padding: 4px 5px 2px 5px; border-color: activeborder; font: normal 11px Arial, Helvetica, sans-serif; color: #000000;" />
							</td>
						</tr>
