...
//s1=s1.replace("%"," ");
 File savedFile;
                       ...
                       String FileUploadPath = getServletContext().getInitParameter("displayDocs"); 
...
%>
	<img src="<%=savedFile %>" width="700" height="600"
		style="vertical-align: middle; margin-left: 10em; margin-top: 1em;">
	<%
