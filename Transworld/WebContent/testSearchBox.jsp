...
String emp=request.getParameter("emp");
	...
	//	     buffer+="<tr><td><a href='#' onClick='showVisitingCardDetails(\""+rs.getString("Name")+"\",\""+rs.getString("UName")+"\");'  style='color: black;'>"+rs.getString("Name").replaceAll("(?i)"+emp,"<font color=blue><u>"+emp.toUpperCase()+"</u></font>")+".</a></tr></td>";
		     buffer+="<tr><td><a href='#' onClick='addRow(\"EmpDataTable\",\""+rs.getString("Name")+"\");'  style='color: black;'>"+rs.getString("Name").replaceAll("(?i)"+emp,"<font color=blue><u>"+emp.toUpperCase()+"</u></font>")+".</a></tr></td>";
			 i++;
		   } 
		   buffer+="</table></div>";
		out.println(buffer);
