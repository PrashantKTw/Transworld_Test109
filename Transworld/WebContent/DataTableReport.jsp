...
<body>
	...
	<br>
	<div align="center">
		<font face="san-serif" color="black" size="4"><b>DataTable
				Standard Report</b></font><br></br>
	...
	<table id="example" class="display"
		...
		<thead>
			<tr>
				...
				<th width="4%"
					style="font-size: 12px; background: #1582AB; color: white; face: san-serif;">Sr
					No</th>
				<th
					style="font-size: 12px; background: #1582AB; color: white; face: san-serif;">Vehicle</th>
				<th
					style="font-size: 12px; background: #1582AB; color: white; face: san-serif;">Entry
					Date & Time</th>
				<th
					style="font-size: 12px; background: #1582AB; color: white; face: san-serif;">Person
					Name</th>
				<th
					style="font-size: 12px; background: #1582AB; color: white; face: san-serif;">Phone
					No</th>
				<!-- <th align="center">tdm_asm</th>
				<th style="font-size:12px ; background: #1582AB;  color:white;    face:san-serif;">tdm_asm_name</th> -->
				<th
					style="font-size: 12px; background: #1582AB; color: white; face: san-serif;">License
					No</th>
				<th
					style="font-size: 12px; background: #1582AB; color: white; face: san-serif;">License
					Validity</th>
				<th
					...
					By</th>
				<th
					style="font-size: 12px; background: #1582AB; color: white; face: san-serif;">Start
					Place</th>
				<th
					style="font-size: 12px; background: #1582AB; color: white; face: san-serif;">End
					Place</th>
