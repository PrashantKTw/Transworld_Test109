...
function validate()
{
	...
	var val2 = document.getElementById("desgName").value;
...
%>
	<br>
	<br>
	<form action="insertCompDet.jsp?action=Designation" method="post">
		<input type="hidden" name="type" id="type" value="1">
		<table bgcolor="#E0DDFE" border="0" height="250" width="450"
			align="center">
			<tr>
				<td align="center"><b><font size="4" color="#151B54">Create
							New Designation</font></b></td>
			</tr>
			<tr>
				<td align="center">
	...
	%> <b><font size="2" color="#151B54"><%= sendMsg%></font></b> <%} %>
			...
			<tr bgcolor="white">
				<td><a href="editDesignation.jsp"
					style="font: normal 14px Arial, Helvetica, sans-serif;">Edit
						Designation</a></td>
			</tr>
			<tr bgcolor="white">
				<td>
					<table border="0" align="center" height="140">
						...
						<tr>
							...
							<td><select name="cmpName" id="cmpName" class="formElement"
								...
								style="width: 250px; height: 20px; border: 1px solid black; font: small Arial, Helvetica, sans-serif; color: #000000; border-color: activeborder;">
						...
						<tr>
							...
							<td><input type="text" name="desgName" id="desgName"
