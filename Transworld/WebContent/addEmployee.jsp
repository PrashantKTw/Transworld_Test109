...
<td width="40%">
<div>
<table border="0" align="center" style="background-color: white;font-family: arial;font-size:12; border-left: 120px">
		<tr>
			<td>
				<form method="post" name="leave"
					action="addEmployeeInsert.jsp?action=addemp"
					onsubmit="return validate();">
					<table bgcolor="#E0DDFE" border="0" align="center" height="450"
						width=550">
						<tr>
							<td align="center"><b><font size="4" color="#151B54">Add
...
if(already==null){
	...
	%>
						<tr>
							<td align="center"><b><font size="3" color="blue">Contractor
...
%>
						...
						<tr bgcolor="white">
							<td><b>Note: <font color="#990000">*</font>Indicate Fields are Mandatory.</b></td>
						</tr>
						<tr bgcolor="white">
							<td>
								<table align="center" border="0" width="95%" height="90%">
									<td><b>Contractor ID<font color="#990000">*</font></b></td>
									<td><input type="text" id="empid" name="empid" value=""
										class="input" /></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><input type="radio" name="typeOfUser" id="reason1"
											value="contractor" />Contractor <input type="radio"
											name="typeOfUser" id="reason2" value="hod" />HOD</td>
									</tr>
									<tr>
									...
									<tr>
										<td style="vertical-align: top;"><b>Type Of
												Department<font color="#990000">*</font>
										</b></td>
						...
						catch(Exception e)
						{
							System.out.println("Exception======>>"+e);
										...
										</select> <!--<input type="radio" name="reason11" id="reason11" value="Software"/>Software
			...
			--></td>
                                  ...
                                  <td><input type="text" name="hod" id="hod" onkeyup="getUserHod()" class="input"/></input></td>
                                   </tr>
                                   <tr>
...
<input type="hidden" name="anothercounter" id="anothercounter" value="10"/>
	...
	-->
								...
								<table align="center">
									...
									<tr>
										<td><input type="submit" id="submit1" value="Submit"
											class="button" /></td>
									</tr>
