			...
			<td>
				<table>
					<tr>
					 ...
					 %>
								<tr>
									<td align="center"><b><%=resendMsg%></b></td>
								</tr>
								<%}
					 else
					 { %>
								<tr>
									<td align="center"><b><font size="4" color="#151B54">Multiple
					...
					<tr>
						<td>
							<form action="IwrdScanRequest.jsp" method="post"
									...
									<table border="0">
										...
										<tr>
											<td align="center"><input type="file" name="MyFile"
												id="MyFile" /> <input type="hidden" name="fileName"
												id="fileName" value=""></input></td>
										</tr>

										<tr>
											<td align="center"><input type="submit"
												id="submitButton1" value="Upload"
