...
<div class="container" id="mainpage">
	...
	String sqlreport = "select ReportNo from t_reportnumber where PageName = '"+PageName1+"'";
	...
	%>
	<%-- <a href="#" onclick="openpopup('<%=PageName1%>')"><font size="2" style="color: #1E21F3;font-family: Montserrat, sans-serif;"><b>Register Complaint*</b></a></font> --%>
	<!-- 		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
	<%-- 		 <font size="2" style="color: black;font-family: Montserrat, sans-serif;"><b>Report No.: <%=reportno %></b></a></font> --%>
...
try
{
 ...
 String email=(String)session.getAttribute("email");
	...
	<form name="incident" style="background: #F5F5F5;" method="post"
		onsubmit="return validateform1();" action="ComplaintInsert.jsp"
...
<br>
		...
		<table align="center"
			style="background: #F5F5F5; width: 55%; margin-left: 25%;">
			<tr>
				<td align="right">
...
<tr>
							<td colspan="5" align="right"
								...
								<font size="2" color="black"> <b><br><%=fname %>
											<br><%=email %></b></font>
						...
						<tr>
							...
							<td valign="top" align="left"><font color="black" size="2"
								face="Arial">Description : </font></td>
							<td>
								<%
			
			%> <textarea name="desc" rows="3" id="search-text"
									style='width: 230px; height: auto; border-color: activeborder;'><%=desc %></textarea>
						...
						<tr>
							...
							<td valign="top" align="left"><font color="black" size="2"
								face="Arial">Report Name: </font></td>
							<td><font color="black" size="2" face="Arial"> <%=ReportName %></font>
								<input type="hidden" name="ReportName" id="ReportName"
								style="width: 230px; height: auto; border-color: white;"
								value="<%=ReportName %>" readonly /></td>
						</tr>
						<tr>
							<td valign="top"><font color="#990000" size="2">*</font></td>
							<td valign="top" align="left"><font color="black" size="2"
			...
			<td>
				<input type="text" name="UserName" id="UserName" style="width:230px; border-color: activeborder;" autocomplete="off"  value=""  /> 
						...
						<tr>
							...
							<td valign="top" align="left"><font color="black" size="2"
								face="Arial">Add Email recepients : </font></td>
							<td>
								<%
			System.out.println("^^^^^^^^^^^ "+EmailID);
			%> <input type="text" name="EmailID" value="<%=EmailID%>"
								id="EmailID" style="width: 230px; border-color: activeborder;"
								autocomplete="off" /> <br>
							<font size="1" face="Arial">Please enter comma separated
									email ids.</font>
							</td>
						</tr>
						<!-- </table>
			<table align="center" border="0" cellpadding="3" width="40%" style="background: #F5F5F5">-->
						...
						<tr>
							<td valign="top"><font color="#990000"></font></td>
							<td valign="top" align="left" colspan="1"><font
								color="black" size="2" face="Arial">Call me back</font> <!-- <td>
            ...
            <input type="radio" name="browser" value="Yes"  onclick="getradio();">Yes
								...
								name="browser" id="browser" value="1" onclick="getradio();"><font
								size="1" face="Arial">Yes </font></td>
							<td align="left" style="display: none;" id="tr3"><input
								type="text" name="Number" id="Number"
								style="width: 230px; border-color: activeborder;"
								autocomplete="off" value="" /><input type="hidden"
								name="Number1" id="Number1"></td>
						</tr>
					</table> <!--  <div id="div2" position="absolute" style="width: 40%; margin-left: 50%">
		              <table align="center" border="0" cellpadding="3" width="40%" style="background: #F5F5F5">
					...
					<table align="center" style="background: #F5F5F5">
						...
						<tr>
							...
							<input type="hidden" name="flagvalue" id="flagvalue"
								value="<%=counter%>"></input>
							<td valign="top" align="left" colspan="1"><b>&nbsp;&nbsp;
									<a href="#" onclick="attach();"><font size="2" face="Arial">Attach
											File</font></a>
							</b>
								<div>
									<font size="1" color="black" face="Arial">&nbsp;&nbsp;(You
										can attach a screen shot of the error page <br>&nbsp;&nbsp;or
										a file which you would like to link with this complaint
										entry.)
									</font>
								</div>
								<div id="div2" position="absolute" style="width: 30%;"
									align="center">
									<table border="0" align="center">
										<tr align="center" id="tr1" style="display: none;">
											...
											<td align="right">&nbsp;&nbsp;<input type="file"
												cols="40" name="Filename1" value="" onchange="upload();" /></td>
											<td style="display: none; width: 20%;" id="imageDiv"
												align="left" colspan="2"><font size="2" face="Arial"
												color="black" id="f1"></font></td>
											<td>&nbsp;&nbsp;&nbsp;<b><a href="#"
													onclick="cancel();"><font size="2" face="Arial">Remove</font></a></b></td>
										</tr>

										<tr align="center" id="tr2" style="display: none;">
											<td valign="top" align="left"><b> &nbsp;&nbsp;<a
													href="#" onclick="attach1();"><font size="2"
														face="Arial">AttachMoreFiles </font></a></td>
										</tr>
										<tr align="center" id="tr5" style="display: none;">
											<!--<td><div id="imageDiv" align="center"><font color="maroon" size="2"><b></b></font></div></td>-->
											<td>&nbsp;&nbsp;<input type="file" cols="40"
												name="Filename2" value="" onchange="upload1();" /></td>
											<td style="display: none; width: 20%;" id="imageDiv1"
												align="left" colspan="2"><font size="2" face="Arial"
												color="black" id="f2"></font></td>
											<td>&nbsp;&nbsp;&nbsp; <b><a href="#"
													onclick="cancel1();"><font size="2" face="Arial">Remove</font></a></b></td>
										</tr>

										<tr align="center" id="tr6" style="display: none;">
											<td valign="top" align="left"><b>&nbsp;&nbsp; <a
													href="#" onclick="attach2();"><font size="2"
														face="Arial">AttachMoreFiles </font></a></td>
										</tr>
										<tr align="center" id="tr7" style="display: none;">
											<!--<td><div id="imageDiv" align="center"><font color="maroon" size="2"><b></b></font></div></td>-->
											<td>&nbsp;&nbsp;<input type="file" cols="40"
												name="Filename3" value="" onchange="upload2();" /></td>
											<td style="display: none; width: 20%;" id="imageDiv2"
												align="left" colspan="2"><font size="2" face="Arial"
												color="black" id="f3"></font></td>
											<td>&nbsp;&nbsp;&nbsp;<b><a href="#"
													onclick="cancel2();"><font size="2" face="Arial">Remove</font></a></b></td>
										</tr>


										<tr align="center" id="tr8" style="display: none;">
											<td valign="top" align="left"><b>&nbsp;&nbsp; <a
													href="#" onclick="attach3();"><font size="2"
														face="Arial">AttachMoreFiles </font></a></td>
										</tr>
										<tr align="center" id="tr9" style="display: none;">
											<!--<td><div id="imageDiv" align="center"><font color="maroon" size="2"><b></b></font></div></td>-->
											<td>&nbsp;&nbsp;<input type="file" cols="40"
												name="Filename4" value="" onchange="upload3();" /></td>
											<td style="display: none; width: 20%;" id="imageDiv3"
												align="left" colspan="2"><font size="2" face="Arial"
												color="black" id="f4"></font></td>
											<td>&nbsp;&nbsp;&nbsp;<b><a href="#"
													onclick="cancel3();"><font size="2" face="Arial">Remove</font></a></b></td>
										</tr>

										<tr align="center" id="tr10" style="display: none;">
											<td valign="top" align="left"><b>&nbsp;&nbsp; <a
													href="#" onclick="attach4();"><font size="2"
														face="Arial">AttachMoreFiles </font></a></td>
										</tr>
										<tr align="center" id="tr11" style="display: none;">
											<!--<td><div id="imageDiv" align="center"><font color="maroon" size="2"><b></b></font></div></td>-->
											<td>&nbsp;&nbsp;<input type="file" cols="40"
												name="Filename5" value="" onchange="upload4();" /></td>
											<td style="display: none; width: 20%;" id="imageDiv4"
												align="left" colspan="2"><font size="2" face="Arial"
												color="black" id="f5"></font></td>
											<td>&nbsp;&nbsp;&nbsp;<b><a href="#"
													onclick="cancel4();"><font size="2" face="Arial">Remove</font></a></b></td>
										</tr>

										<tr align="center" id="tr12" style="display: none;">
											<td valign="top" align="left"><b>&nbsp;&nbsp; <a
													href="#" onclick="attach5();"><font size="2"
														face="Arial">AttachMoreFiles </font></a></td>
										</tr>
										<tr align="center" id="tr13" style="display: none;">
											<!--<td><div id="imageDiv" align="center"><font color="maroon" size="2"><b></b></font></div></td>-->
											<td>&nbsp;&nbsp;<input type="file" cols="40"
												name="Filename6" value="" onchange="upload5();" /></td>
											<td style="display: none; width: 20%;" id="imageDiv5"
												align="left" colspan="2"><font size="2" face="Arial"
												color="black" id="f6"></font></td>
											<td>&nbsp;&nbsp;&nbsp;<b><a href="#"
													onclick="cancel5();"><font size="2" face="Arial">Remove</font></a></b></td>
										</tr>

										<tr align="center" id="tr14" style="display: none;">
											<td valign="top" align="left"><b> &nbsp;&nbsp;<a
													href="#" onclick="attach6();"><font size="2"
														face="Arial">AttachMoreFiles </font></a></td>
										</tr>
										<tr align="center" id="tr15" style="display: none;">
											<!--  <td><div id="imageDiv" align="center"><font color="maroon" size="2"><b></b></font></div></td>-->
											<td>&nbsp;&nbsp;<input type="file" cols="40"
												name="Filename7" value="" onchange="upload6();" /></td>
											<td style="display: none; width: 20%;" id="imageDiv6"
												align="left" colspan="2"><font size="2" face="Arial"
												color="black" id="f7"></font></td>
											<td>&nbsp;&nbsp;&nbsp; <b><a href="#"
													onclick="cancel6();"><font size="2" face="Arial">Remove</font></a></b></td>
										</tr>

										<tr align="center" id="tr16" style="display: none;">
											<td valign="top" align="left"><b> &nbsp;&nbsp;<a
													href="#" onclick="attach7();"><font size="2"
														face="Arial">AttachMoreFiles </font></a></td>
										</tr>
										<tr align="center" id="tr17" style="display: none;">
											<!--<td><div id="imageDiv" align="center"><font color="maroon" size="2"><b></b></font></div></td>-->
											<td>&nbsp;&nbsp;<input type="file" cols="40"
												name="Filename8" value="" onchange="upload7();" /></td>
											<td style="display: none; width: 20%;" id="imageDiv7"
												align="left" colspan="2"><font size="2" face="Arial"
												color="black" id="f8"></font></td>
											<td>&nbsp;&nbsp;&nbsp;<b><a href="#"
													onclick="cancel7();"><font size="2" face="Arial">Remove</font></a></b></td>
										</tr>

										<tr align="center" id="tr18" style="display: none;">
											<td valign="top" align="left"><b> &nbsp;&nbsp;<a
													href="#" onclick="attach8();"><font size="2"
														face="Arial">AttachMoreFiles </font></a></td>
										</tr>
										<tr align="center" id="tr19" style="display: none;">
											<!--<td><div id="imageDiv" align="center"><font color="maroon" size="2"><b></b></font></div></td>-->
											<td>&nbsp;&nbsp;<input type="file" cols="40"
												name="Filename9" value="" onchange="upload8();" /></td>
											<td style="display: none; width: 20%;" id="imageDiv8"
												align="left" colspan="2"><font size="2" face="Arial"
												color="black" id="f9"></font></td>
											<td>&nbsp;&nbsp;&nbsp; <b><a href="#"
													onclick="cancel8();"><font size="2" face="Arial">Remove</font></a></b></td>
										</tr>

										<tr align="center" id="tr20" style="display: none;">
											<td valign="top" align="left"><b> &nbsp;&nbsp;<a
													href="#" onclick="attach9();"><font size="2"
														face="Arial">AttachMoreFiles</font> </a></td>
										</tr>
										<tr align="center" id="tr21" style="display: none;">
											<!-- <td><div id="imageDiv" align="center"><font color="maroon" size="2"><b></b></font></div></td>-->
											<td>&nbsp;&nbsp;<input type="file" cols="40"
												name="Filename10" value="" onchange="upload9();" /></td>
											<td style="display: none; width: 20%;" id="imageDiv9"
												align="left" colspan="2"><font size="2" face="Arial"
												color="black" id="f10"></font></td>
											<td>&nbsp;&nbsp;&nbsp; <b><a href="#"
													onclick="cancel9();"><font size="2" face="Arial">Remove</font></a></b></td>
										</tr>
					...
					<table align="center" border="0" cellpadding="3" width="40%"
						style="background: #F5F5F5; margin-left: 18%;">
