...
<%
	...
	try {
		...
		con1 = DriverManager.getConnection("jdbc:mysql://103.241.181.36:3306/db_leaveapplication", "erp",
				"1@erp");
		...
		String buffer = "<div style='height:auto;width:100%;overflow:auto;'><table border='1' style='width:100%; overflow:auto;'>";
		int i = 1;
		String val = "", val1 = "";
		String pono = "", PODate = "";
